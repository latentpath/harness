...
relevant code paths, tests, configuration, and dependencies before citing an
existing convention or file path.
...
`harness/work/<task-id>/spec.md`, `harness/work/<task-id>/approval.json`,
production code, tests, configuration, `harness/work/<task-id>/development.md`,
or `harness/work/<task-id>/review.md`.

Distinguish verified existing paths from tentative new paths. If verified facts
conflict with the spec, describe the conflict and stop for a material decision.
